...
public class LineFormatterTest extends RandomizedTest {
  ...
  public void alignmentAndTrimTruncated() {
    check(
        "...ef",
        5,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.RIGHT, Trim.RIGHT, "abcdef"));
    check(
        "ab...",
        5,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.RIGHT, Trim.LEFT, "abcdef"));
    check(
        "...",
        3,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.RIGHT, Trim.LEFT, "abcdef"));
    ...
    check(
        "ab...",
        5,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.LEFT, Trim.LEFT, "abcdef"));
    check(
        "...ef",
        5,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.LEFT, Trim.RIGHT, "abcdef"));
    check(
        "...",
        3,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.LEFT, Trim.RIGHT, "abcdef"));
    ...
    check(
        "a...f",
        5,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.LEFT, Trim.MIDDLE, "abcdef"));
    check(
        "a...",
        4,
        new LineFormatter().cell(0, Integer.MAX_VALUE, Alignment.LEFT, Trim.MIDDLE, "abcdef"));
  ...
  public void multiFields() {
    check("abcdef", 6, new LineFormatter().cell("abc").cell("def"));
    // Unpadded.
    check("abcdef", 7, new LineFormatter().cell("abc").cell("def"));
    // Not enough space for the second field.
    check("abc", 5, new LineFormatter().cell("abc").cell("def"));
  }

  @Test
  public void multiFieldsWithStretchables() {
    check("abcdef ", 7, new LineFormatter().cell("abc").cell(0, "def"));
    check("abc def", 7, new LineFormatter().cell(0, "abc").cell("def"));
    check("abcdef ", 7, new LineFormatter().cell("abc").cell(0, "def"));
    check("abc def ", 8, new LineFormatter().cell(0, "abc").cell(0, "def"));
  }

  @Test
  public void stretchablesWithLimit() {
    check("abc  |def  ", 100, new LineFormatter().cell(3, 5, "abc").cell("|").cell(3, 5, "def"));
